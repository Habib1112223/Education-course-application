...
const Footer = () => {
      return (
            <footer className="footer footer-center p-10 bg-amber-500 text-primary-content" data-aos="zoom-in-right">
                  <aside>
                        ...
                        <p className="font-bold">
                              LearnHub Education Ltd. <br />Providing Teach  since 1992
                        </p>
